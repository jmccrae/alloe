 ...
 *
 *  $Id: POSTagger.java 8929 2007-07-12 16:49:55Z ian_roberts $
 */
 ...
 * @version 1.0
 */
package nii.alloe.preprocess.postag;
...
import nii.alloe.preprocess.postag.rules.*;
...
//    public Rule[] lastRules = new Rule[MAXTAGS];
  ...
  public Rule createNewRule(String ruleId) throws InvalidRuleException{
    try{
      String className = "nii.alloe.preprocess.postag.rules.Rule_" + ruleId;
