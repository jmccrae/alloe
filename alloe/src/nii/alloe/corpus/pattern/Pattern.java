...
public class Pattern implements java.io.Serializable, Comparable<Pattern> {
    ...
    private transient int initialDist = -1;
    ...
    public int initialDist() {
        ...
        return initialDist = i;
    }
    private transient int interPairDist = -1;

    /** @return the number of wildcards between capturers */
    public int interPairDist() {
        if (interPairDist >= 0) {
            return interPairDist;
        }
        String[] s = split();
        int rval = 0;
        boolean count = false;
        ...
        return interPairDist = rval;
    }
    private transient int finalDist = -1;
    ...
    public int finalDist() {
        ...
        return finalDist = s.length - i - 1;
    }
    private transient int orient = 0;
    ...
    public Pattern getMostDominant() {
        String val = this.val;
        val = val.replaceAll("^[\\* ]*", "");
        val = val.replaceAll("[\\* ]*$", "");
